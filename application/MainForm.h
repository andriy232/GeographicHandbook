		...
		void InitializeComponent(void)
		{
			...
			this->файлToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->зберегтиToolStripMenuItem,
					this->друкуватиToolStripMenuItem, this->вихідToolStripMenuItem
			});
			...
			this->зберегтиToolStripMenuItem->Size = System::Drawing::Size(131, 22);
...
private: void saveToFile()
{
	...
	//об'єднуємо строки
	String^ strFile = "\n \tВихідний файл програми 'Географічний довідник' \n\n" + "Країна: " + name
		+ "\n\nРозташування зображення прапору: " + pict
		+ "\nЗагальна інформація:\n" + main
		+ "\nПовна інформація:\n" + full;
